...
Genaueres zu React kann wurden der Quelle \cite{React} entnommen.
\begin{figure}[h]
	\centering
...
Quelle: Instalation von Laravel
...
Quelle: Dokumentation der Installation von Bootstrap
...
Quelle Grafana HTTP API \\
Quelle "guzzle-http" Laravel Paket 
\begin{figure}[h]
	\centering
