...
Um die Anbieter auf die gewünschten Anforderungen zu Überprüfen wurde die Liste angefertigt. Daten für diese Tabelle wurden den Quellen ... entnommen.
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|}
		...
		MAIL\_PORT       & Hier der Port über welchen zugegriffen werden soll \\ \hline
		...
		MAIL\_FROM\_ADDRESS & Hier die Adresse, welche beim Empfänger als Sender E-Mail angezeigt wird                      \\ \hline
		MAIL\_FROM\_NAME & Hier der Name, der dem Empfänger angezeigt wird    \\ \hline
	\end{tabular}
...
Eine Liste mit allen Icons und deren Bedeutung ist im Coperate Design Manuel auf der DVD der Diplomarbeit ersichtlich.
...
\begin{figure}[h]
	\centering
	\includegraphics[height=2cm,width=10cm]{images/IconAutorVerlinkungen}
...
\subsection{Buttons}
Buttons werden bei diesem Produkt ausschließlich genutzt, um Formulare abzusenden. Buttons befinden sich immer mittig unter einem Formular und  haben die Hintergrundfarbe \#1b8836. In Abbildung \ref{fig: Beispiel eines Buttons}ist ein Beispielbutton erschlich. 
\begin{figure}[h]
	\centering
