...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|}
		...
		\begin{tabular}[t]{@{}l@{}}Es gibt nicht genug Möglichkeiten,\\ eine Webapp zu erstellen \\ und benötigt Zusatzbibliotheken; \\ schweres debuggen\footnote{debuggen ist die Fehlerkontrolle des Programms vor dem Start};\\ komplexe Benutzeroberfläche\end{tabular} \\ \hline
		ASP.NET &
...
\begin{figure}[h]
	\centering
	\includegraphics[height=10cm,width=14cm]{images/Statistikanzeigen}
