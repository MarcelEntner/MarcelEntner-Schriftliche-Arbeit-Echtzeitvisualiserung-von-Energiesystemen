...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|}
		\hline
		\textbf{Framework oder Bibliothek } &
		\textbf{Vorteile} &
		\textbf{Nachteile }\\ \hline
		React &
...
Im Abschnitt Weboberfläche wird speziell auf das Front-End sowie das Back-End des Produkts eingegangen. Bei dem Punkt Back-End vor allem auf die Funktionen, die für die Benutzer-Interaktionen zuständig sind, und bei dem Punkt Front-End auf das Layout sowie das Design der Weboberfläche.
