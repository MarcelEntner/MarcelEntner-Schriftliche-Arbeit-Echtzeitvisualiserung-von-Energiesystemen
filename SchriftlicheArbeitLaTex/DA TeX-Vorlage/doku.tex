...
Genaure Informatione zu ASP.Net können unter der Quelle \cite{asp} nachgelesen werden.
\newpage
\subsubsection{React}
...
\begin{lstlisting}[
	caption={Erstellen eines neuen Controllers},
	label=Code,
	language=octave,
	numbers=left,
	firstnumber=1,
...
\begin{lstlisting}[
	caption={Erstellen eines neuen Resource Controllers},
	label=Code,
	language=octave,
	numbers=left,
	firstnumber=1,
...
\begin{lstlisting}[
	caption={Start des Develop Servers},
	label=Code,
	language=octave,
	numbers=left,
	firstnumber=1,
