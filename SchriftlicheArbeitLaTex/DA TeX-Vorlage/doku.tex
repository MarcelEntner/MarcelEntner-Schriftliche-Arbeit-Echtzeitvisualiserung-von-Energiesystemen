...
Dieser Kommand sorgt dafür, dass der APP_KEY in der .env Datei richtig gesetzt wird:
\begin{lstlisting}[
	caption={Erstellen einer neuen Migration},
	label=Code,
	language=octave,
...
Das Produkt ist unter dem Link https://github.com/MarcelEntner/Echtzeit_Visualisierung_Energiesysteme.git  aufrufbar.
